...
# We wondered how often this has happened over the years but 
# we got sidetracked with other topics and we never came up with an answer.
# “When I got home I figured out that the digits of our ages have 
# been reversible six times so far. I also figured out that if we’re lucky it 
# would happen again in a few years, and if we’re really lucky it 
# would happen one more time after that. In other words, it would 
